//! Register access for the functional group virtual memory control
// Author: Moritz Doll
// License: MIT
...
register_bitfields! {u32,
    SCTLR [
        ...
        TEXREMAP OFFSET(28) NUMBITS(1) [Enabled = 1, Disabled = 0],
        ACCFLAG OFFSET(29) NUMBITS(1) [Enabled = 1, Disabled = 0],
